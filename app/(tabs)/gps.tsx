  ...
  const exportCSV = async () => {
    try {
      ...
      if (isSharingAvailable) {
        ...
        setErrorMsg('sharing not available on this device. file saved to: ' + file.uri);
      }
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        ...
        <Text style={styles.counterText}>Collected: {gpsData.length} points</Text>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Pressable 
            style={[styles.button, styles.stopButton, !isCollecting && styles.buttonDisabled]} 
            onPress={() => {
              stopCollecting();
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
            }}
          ...
          <Pressable 
            style={[styles.button, styles.restartButton, (!isCollecting && gpsData.length === 0) && styles.buttonDisabled]} 
            onPress={() => {
              restartCollecting();
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
            }}
          ...
          <Pressable 
            style={[styles.button, styles.exportButton, gpsData.length === 0 && styles.buttonDisabled]} 
            onPress={() => {
              exportCSV();
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
            }}
